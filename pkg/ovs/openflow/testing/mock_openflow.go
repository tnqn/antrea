...
// MatchCTLabel mocks base method
func (m *MockFlowBuilder) MatchCTLabel(arg0, arg1 uint64) openflow.FlowBuilder {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MatchCTLabel", arg0, arg1)
	ret0, _ := ret[0].(openflow.FlowBuilder)
	return ret0
}

// MatchCTLabel indicates an expected call of MatchCTLabel
func (mr *MockFlowBuilderMockRecorder) MatchCTLabel(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MatchCTLabel", reflect.TypeOf((*MockFlowBuilder)(nil).MatchCTLabel), arg0, arg1)
}
