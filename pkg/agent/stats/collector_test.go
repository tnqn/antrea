...
func TestCalculateDiff(t *testing.T) {
	tests := []struct {
		name              string
		lastStats         map[types.UID]*metricsv1alpha1.TrafficStats
		curStats          map[types.UID]*metricsv1alpha1.TrafficStats
		expectedstatsList []cpv1alpha1.NetworkPolicyStats
	}{
		{
			...
			expectedstatsList: []cpv1alpha1.NetworkPolicyStats{
				{
					NetworkPolicy: cpv1alpha1.NetworkPolicyReference{UID: "uid1"},
				...
				{
					NetworkPolicy: cpv1alpha1.NetworkPolicyReference{UID: "uid2"},
					TrafficStats: metricsv1alpha1.TrafficStats{
						Bytes:    30,
						Packets:  5,
						Sessions: 3,
