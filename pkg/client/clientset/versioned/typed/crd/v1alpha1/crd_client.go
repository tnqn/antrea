...
// CrdV1alpha1Client is used to interact with features provided by the crd.antrea.tanzu.vmware.com group.
type CrdV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CrdV1alpha1Client) TierEntitlements() TierEntitlementInterface {
	return newTierEntitlements(c)
}

func (c *CrdV1alpha1Client) TierEntitlementBindings() TierEntitlementBindingInterface {
