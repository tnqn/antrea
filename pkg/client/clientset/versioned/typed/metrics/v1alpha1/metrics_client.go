...
type MetricsV1alpha1Interface interface {
	...
	ClusterNetworkPolicyMetricsesGetter
...
func (c *MetricsV1alpha1Client) ClusterNetworkPolicyMetricses() ClusterNetworkPolicyMetricsInterface {
	return newClusterNetworkPolicyMetricses(c)
}
