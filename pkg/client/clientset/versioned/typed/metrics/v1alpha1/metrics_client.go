...
type MetricsV1alpha1Interface interface {
	...
	ClusterNetworkPolicyMetricsGetter
}
...
func (c *MetricsV1alpha1Client) ClusterNetworkPolicyMetrics() ClusterNetworkPolicyMetricInterface {
	return newClusterNetworkPolicyMetrics(c)
}
