...
func (c *FakeNetworkPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.NetworkPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(networkpoliciesResource, name), &v1beta1.NetworkPolicy{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeNetworkPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.NetworkPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(networkpoliciesResource, networkpoliciesKind, opts), &v1beta1.NetworkPolicyList{})
	if obj == nil {
		return nil, err
	}
