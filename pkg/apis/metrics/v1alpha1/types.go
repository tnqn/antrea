...
// +genclient
// +resourceName=k8snetworkpolicies
// +genclient:readonly
// +genclient:nonNamespaced
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object

// K8sNetworkPolicyMetric is the query options to a Pod's proxy call
...
// K8sNetworkPolicyMetricList is the query options to a Pod's proxy call
type K8sNetworkPolicyMetricList struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ListMeta   `json:"metadata,omitempty" protobuf:"bytes,1,opt,name=metadata"`

	// List of K8sNetworkPolicy metrics.
	Items []K8sNetworkPolicyMetric `json:"items" protobuf:"bytes,2,rep,name=items"`
}
