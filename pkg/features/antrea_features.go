...
const (
	...
	// alpha: v0.10
	// Enable collecting and exporting NetworkPolicy Metrics.
	NetworkPolicyMetrics featuregate.Feature = "NetworkPolicyMetrics"
)
...
var (
	...
	defaultAntreaFeatureGates = map[featuregate.Feature]featuregate.FeatureSpec{
		...
		NetworkPolicyMetrics: {Default: false, PreRelease: featuregate.Alpha},
	}
)
