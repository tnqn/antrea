...
func (i *GroupEntityIndex) createLabelItem(entityType entityType, eItem *entityItem) *labelItem {
	...
	scanSelectors := func(selectorItemKeys sets.String) {
	...
	scanSelectors(localSelectorItemKeys)
	// Cluster scoped selectorItems may match the labelItem.
	clusterSelectorItemKeys, _ := i.selectorItemIndex[entityType][""]
	scanSelectors(clusterSelectorItemKeys)
	return lItem
}
...
func (i *GroupEntityIndex) syncSelector(sItem *selectorItem) bool {
	...
	scanLabels := func(labelItemKeys sets.String) {
