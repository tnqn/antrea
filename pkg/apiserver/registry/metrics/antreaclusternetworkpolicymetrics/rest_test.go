...
type fakeMetricsProvider struct {
	metrics map[string]metricsv1alpha1.AntreaClusterNetworkPolicyMetrics
}

func (p *fakeMetricsProvider) ListAntreaClusterNetworkPolicyMetrics() []metricsv1alpha1.AntreaClusterNetworkPolicyMetrics {
	list := make([]metricsv1alpha1.AntreaClusterNetworkPolicyMetrics, 0, len(p.metrics))
...
func (p *fakeMetricsProvider) GetAntreaClusterNetworkPolicyMetrics(name string) (*metricsv1alpha1.AntreaClusterNetworkPolicyMetrics, bool) {
...
func TestRESTGet(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			cnp: "foo",
			expectedObj: &metricsv1alpha1.AntreaClusterNetworkPolicyMetrics{
				ObjectMeta: metav1.ObjectMeta{
					Name: "foo",
				},
			},
...
func TestRESTList(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			antreaPolicyEnabled:         true,
			metrics:                     map[string]metricsv1alpha1.AntreaClusterNetworkPolicyMetrics{},
			expectedObj: &metricsv1alpha1.AntreaClusterNetworkPolicyMetricsList{
				Items: []metricsv1alpha1.AntreaClusterNetworkPolicyMetrics{},
			},
			expectedErr: false,
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectedObj == nil {
				...
				assert.ElementsMatch(t, tt.expectedObj.(*metricsv1alpha1.AntreaClusterNetworkPolicyMetricsList).Items, actualObj.(*metricsv1alpha1.AntreaClusterNetworkPolicyMetricsList).Items)
			}
		})
	}
}
