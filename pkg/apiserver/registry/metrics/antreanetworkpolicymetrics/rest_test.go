...
package antreanetworkpolicymetrics
...
type fakeMetricsProvider struct {
	metrics map[string]map[string]metricsv1alpha1.AntreaNetworkPolicyMetrics
}

func (p *fakeMetricsProvider) ListAntreaNetworkPolicyMetrics(namespace string) []metricsv1alpha1.AntreaNetworkPolicyMetrics {
	var list []metricsv1alpha1.AntreaNetworkPolicyMetrics
	if namespace == "" {
...
func (p *fakeMetricsProvider) GetAntreaNetworkPolicyMetrics(namespace, name string) (*metricsv1alpha1.AntreaNetworkPolicyMetrics, bool) {
...
func TestRESTGet(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			npNamespace: "foo",
			npName:      "bar",
			expectedObj: &metricsv1alpha1.AntreaNetworkPolicyMetrics{
				ObjectMeta: metav1.ObjectMeta{
					Namespace: "foo",
					Name:      "bar",
				},
...
func TestRESTList(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			npNamespace: "",
			expectedObj: &metricsv1alpha1.AntreaNetworkPolicyMetricsList{
				Items: []metricsv1alpha1.AntreaNetworkPolicyMetrics{
					{
						ObjectMeta: metav1.ObjectMeta{
							Namespace: "foo",
							Name:      "bar",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectedObj == nil {
				...
				assert.ElementsMatch(t, tt.expectedObj.(*metricsv1alpha1.AntreaNetworkPolicyMetricsList).Items, actualObj.(*metricsv1alpha1.AntreaNetworkPolicyMetricsList).Items)
			}
		})
	}
}
