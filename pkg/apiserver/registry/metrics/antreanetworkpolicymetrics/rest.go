...
type metricsProvider interface {
	ListAntreaNetworkPolicyMetrics(namespace string) []metricsv1alpha1.AntreaNetworkPolicyMetrics

	GetAntreaNetworkPolicyMetrics(namespace, name string) (*metricsv1alpha1.AntreaNetworkPolicyMetrics, bool)
}

func (r *REST) New() runtime.Object {
	return &metricsv1alpha1.AntreaNetworkPolicyMetrics{}
}
...
func (r *REST) List(ctx context.Context, options *internalversion.ListOptions) (runtime.Object, error) {
	...
	items := r.metricsProvider.ListAntreaNetworkPolicyMetrics(ns)
	metricList := &metricsv1alpha1.AntreaNetworkPolicyMetricsList{
		Items: items,
	}
...
func (r *REST) Get(ctx context.Context, name string, options *metav1.GetOptions) (runtime.Object, error) {
	...
	metric, exists := r.metricsProvider.GetAntreaNetworkPolicyMetrics(ns, name)
	if !exists {
		return nil, errors.NewNotFound(metricsv1alpha1.Resource("antreanetworkpolicymetrics"), name)
	}
	return metric, nil
}
...
func (r *REST) ConvertToTable(ctx context.Context, obj runtime.Object, tableOptions runtime.Object) (*metav1.Table, error) {
	...
	table.Rows, err = metatable.MetaToTableRow(obj, func(obj runtime.Object, m metav1.Object, name, age string) ([]interface{}, error) {
		metrics := obj.(*metricsv1alpha1.AntreaNetworkPolicyMetrics)
