...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetrics":           schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetrics(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetricsList":       schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetricsList(ref),
...
func schema_pkg_apis_controlplane_v1alpha1_NetworkPolicyReference(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NetworkPolicyReference identifies a NetworkPolicy across all kinds of NetworkPolicies.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"category": {
						SchemaProps: spec.SchemaProps{
							Description: "The category of the NetworkPolicy.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"namespace": {
						SchemaProps: spec.SchemaProps{
							Description: "The Namespace of the NetworkPolicy. It's empty for ClusterNetworkPolicy.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "The name of the NetworkPolicy.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"networkPolicies": {
						SchemaProps: spec.SchemaProps{
							Description: "The TrafficStats collected from the Node.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetrics(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkPolicyMetrics is the metrics of a ClusterNetworkPolicy.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"trafficStats": {
						SchemaProps: spec.SchemaProps{
							Description: "The metrics of the ClusterNetworkPolicy.",
							Ref:         ref("github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.TrafficStats"),
						},
					},
				},
...
func schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetricsList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkPolicyMetricsList is a list of ClusterNetworkPolicyMetrics.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "List of ClusterNetworkPolicyMetrics.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetrics"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetrics", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
