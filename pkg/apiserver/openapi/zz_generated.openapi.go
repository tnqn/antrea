...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetric":            schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetric(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetricList":        schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetricList(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.K8sNetworkPolicyMetric":                schema_pkg_apis_metrics_v1alpha1_K8sNetworkPolicyMetric(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.K8sNetworkPolicyMetricList":            schema_pkg_apis_metrics_v1alpha1_K8sNetworkPolicyMetricList(ref),
		"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.NetworkPolicyStats":                    schema_pkg_apis_metrics_v1alpha1_NetworkPolicyStats(ref),
...
func schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetric(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkPolicyMetric is the query options to a Pod's proxy call",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"stats": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.NetworkPolicyStats"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.NetworkPolicyStats", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}

func schema_pkg_apis_metrics_v1alpha1_ClusterNetworkPolicyMetricList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ClusterNetworkPolicyMetricList is the query options to a Pod's proxy call",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "List of ClusterNetworkPolicy metrics.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetric"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.ClusterNetworkPolicyMetric", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_metrics_v1alpha1_K8sNetworkPolicyMetric(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "K8sNetworkPolicyMetric is the query options to a Pod's proxy call",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_metrics_v1alpha1_K8sNetworkPolicyMetricList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "K8sNetworkPolicyMetricList is the query options to a Pod's proxy call",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "List of K8sNetworkPolicy metrics.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.K8sNetworkPolicyMetric"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vmware-tanzu/antrea/pkg/apis/metrics/v1alpha1.K8sNetworkPolicyMetric", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_metrics_v1alpha1_NetworkPolicyStats(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
