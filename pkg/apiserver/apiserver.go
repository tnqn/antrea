...
import (
	...
	"github.com/vmware-tanzu/antrea/pkg/apiserver/registry/metrics/antreaclusternetworkpolicymetrics"
	"github.com/vmware-tanzu/antrea/pkg/apiserver/registry/metrics/antreanetworkpolicymetrics"
...
func installAPIGroup(s *APIServer, c completedConfig) error {
	...
	networkingGroup.VersionedResourcesStorageMap["v1beta1"] = cpv1beta1Storage
	...
	metricsStorage["antreaclusternetworkpolicymetrics"] = antreaclusternetworkpolicymetrics.NewREST(c.extraConfig.statsAggregator)
	metricsStorage["antreanetworkpolicymetrics"] = antreanetworkpolicymetrics.NewREST(c.extraConfig.statsAggregator)
	metricsGroup.VersionedResourcesStorageMap["v1alpha1"] = metricsStorage

	groups := []*genericapiserver.APIGroupInfo{&cpGroup, &networkingGroup, &systemGroup, &metricsGroup}
